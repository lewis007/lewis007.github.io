...
> 原文地址：https://www.ibm.com/developerworks/cn/java/j-understanding-functional-programming-3/index.html
> 
> **系列内容：**
> 
> 此内容是该系列 5 部分中的第 3 部分： **深入理解 Java 函数式编程**
> * [第 1 部分: 函数式编程思想概论](functional-programming-1.html)
> * [第 2 部分: 函数式编程中的重要概念](functional-programming-2.html)
> * 第 3 部分: Java 8 的 Lambda 表达式和流处理
> * [第 4 部分: 使用 Vavr 进行函数式编程](functional-programming-4.html)
> * [第 5 部分: 深入解析 Monad](functional-programming-5.html)

在本系列的前两篇文章中，已经对[函数式编程的思想](functional-programming-1.html)和[函数式编程的重要概念](functional-programming-2.html)做了介绍。本文将介绍 Java 平台本身对函数式编程的支持，着重介绍 Lambda 表达式和流（Stream）。
...
Java 8 引入的 Lambda 表达式和流处理是可以极大提高开发效率的重要特性。每个 Java 开发人员都应该熟练掌握它们的使用。本文从 JSR 335 出发对 Lambda 表达式进行了深入的介绍，同时也对流的特征和操作进行了详细说明。[下一篇](functional-programming-4.html)文章将对 Java 平台上流行的函数式编程库 Vavr 进行介绍。
